...
$html="<form action='newmessage.php' method='post' id='contribution'>
    <p>Compose your message</p>
    <label>To:<input type='text' name='name' list='friendList' value='$name' required></label>
    <p>Your message:</p>
    <textarea name='description'>$_POST[description]</textarea>
    <input type='submit' value='Send'>
  	</form>	";	

printDocument('New Message');
