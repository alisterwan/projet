<?php
	...
	function insertUser($firstname,$surname,$sex,$address,$city,$country,$user,$pass,$email,$avatar){
	$query = sprintf("INSERT INTO users(firstname,surname,sex,address,city,country,username,password,mail,avatar) VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s');", mysql_real_escape_string(strip_tags($firstname)),mysql_real_escape_string(strip_tags($surname)),mysql_real_escape_string(strip_tags($sex)),mysql_real_escape_string(strip_tags($address)),mysql_real_escape_string(strip_tags($city)),mysql_real_escape_string(strip_tags($country)),mysql_real_escape_string(strip_tags($user)),mysql_real_escape_string(strip_tags($pass)),mysql_real_escape_string(strip_tags($email)), mysql_real_escape_string(strip_tags($avatar)));
	...
	function printForm($firstname,$surname,$sex,$address,$city,$country,$user,$email) {
		global $html;
		$html .= "
...
<option value='Zimbabwe'>Zimbabwe</option>
	...
	if ($_POST) { 
		...
		if (strlen($pass)<8 || $pass != $_POST[passcheck]) {
			...
			printForm($firstname,$surname,$sex,$address,$city,$country,$user,$email);
		}
		...
		// On vérifie si la valeur du mail saisie correspond à une adresse valide.
			...
			printForm($firstname,$surname,$sex,$address,$city,$country,$user,'');
		}
		...
		// Vérification si le username du client est déjà dans la base de donnée
			...
			printForm($firstname,$surname,$sex,$address,$city,$country,'',$email);
		}
		...
		// Ajout d'un nouveau client dans la base de donnée
			...
			else { $avatar = './img/avatar/woman_default.png'; }
			
			$res1 = insertUser($firstname,$surname,$sex,$address,$city,$country,$user,$pass,$email,$avatar);
			...
			$message = "<p>You have been successfully registered. <a href='./index.php'>here</a></p>";
