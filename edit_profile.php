...
function updateUser($firstname, $surname, $address, $city, $country, $username, $email, $userid) {
	// fonction qui update sur la BDD
...
if ($_POST && isset($_GET['mode']) && $_GET['mode'] == 'profile_edit_process') {
	// ça va appeler la fonction qui va modifier la BDD : updateUser
