...
$html= "<p>Your profile information:</p>
  <form action='./edit_profile.php' method='post'>
    <table>
    <tr><td>Firstname:</td><td><input type='text' name='firstname' value='$user[0]' required></td></tr>
    <tr><td>Surname:</td><td><input type='text' name='surname' value='$user[1]' required></td></tr>
    <tr><td>Address:</td><td><input type='text' name='address' value='$user[3]' required></td></tr>
    <tr><td>City:</td><td><input type='text' name='city' value='$user[4]' required></td></tr>
    <tr><td>Country:</td><td><select name='country' value='$user[5]' required>   
...
<option value='Zimbabwe'>Zimbabwe</option>
    ...
    <tr><td>Username:</td><td><input type='text' name='username' value='$user[6]' required></td></tr>
    <tr><td>Email:</td><td><input type='text' name='mail' value='$user[8]' required></td></tr>
